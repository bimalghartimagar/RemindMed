...
export default class NotificationService {
  ...
  scheduleNotif(soundName, scheduledDate) {
    this.lastId++;
    PushNotification.localNotificationSchedule({
      ...
      /* Android Only Properties */
      channelId: soundName ? 'sound-channel-id' : 'default-channel-id',
      ticker: 'EyeDropReminder Ticker', // (optional)
      autoCancel: true, // (optional) default: true
      largeIcon: 'ic_launcher', // (optional) default: "ic_launcher"
      smallIcon: 'ic_notification', // (optional) default: "ic_notification" with fallback for "ic_launcher"
      bigText: 'It is that time of day where you need to water your eyes.', // (optional) default: "message" prop
      subText: 'Water your eyes', // (optional) default: none
      ...
      /* iOS and Android properties */
      id: this.lastId, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
      title: 'Eye Drop Reminder', // (optional)
      message: 'Time to water your eyes', // (required)
